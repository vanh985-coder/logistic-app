...
export default function DebugTechnicalPage() {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
                  LOGIX-3D <span className="text-xs font-mono font-normal px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20">Chẩn đoán hệ thống nội bộ</span>
                </h1>
                <p className="text-sm text-muted-foreground mt-0.5">
                  Bảng kiểm tra trạng thái kỹ thuật hạ tầng NestJS, PostgreSQL, Redis và tiêu chuẩn kiến trúc
                </p>
              </div>
            </div>
          </div>
